...
import CongvandenPage from '../../src/pages/CongvanPage/CongvandenPage';
import QLCongvanPage from '../pages/QLcongvanPage/QLcongvanPage';
...
const RouterComponent = ({ setBreadcrumb }) => (
  <Routes>
    ...
    <Route path="/Congvanden" element={<CongvandenPage setBreadcrumb={setBreadcrumb} />} />
    <Route path="/Congvannoibo" element={<CongvannoiboPage setBreadcrumb={setBreadcrumb} />} />
    <Route path="/QLCongvan" element={<QLCongvanPage setBreadcrumb={setBreadcrumb} />} />
